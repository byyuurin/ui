...
import unocssPreset, { cssVarsAll, cssVarsPrefix } from '../unocss-preset'

export function createMergeRules(theme: Theme = {}): CRRule[] {
...
const theme = mergeDeep(presetMini().theme, unocssPreset().theme)

export const rules = createMergeRules(theme)

export const createVariants = cv(rules)
