...
export { default as Collapsible } from './runtime/components/Collapsible.vue'
...
export { default as Separator } from './runtime/components/Separator.vue'
export { default as Slider } from './runtime/components/Slider.vue'
export { default as Switch } from './runtime/components/Switch.vue'
export { default as Table } from './runtime/components/Table.vue'
