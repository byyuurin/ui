  ...
  variants: {
    variant: {
      'solid': {
        ...
        indicator: 'bg-soft-ui-fill/90 rounded-ui-tabs shadow-xs',
      },
      'outline': {
        list: 'bg-soft-ui-cb/5 rounded-ui-tabs',
        trigger: [
      ...
      'soft': {
        ...
        indicator: 'bg-soft-ui-fill/10 rounded-ui-tabs shadow-xs',
      },
      'soft-outline': {
        list: 'bg-soft-ui-cb/5 rounded-ui-tabs',
        trigger: [
        ...
        indicator: 'bg-soft-ui-fill/10 rounded-ui-tabs shadow-xs ring ring-inset ring-ui-content/40',
      },
      'link': {
