...
import type { AvatarProps } from '@byyuurin/ui'
...
const controls: ControlItems<AvatarProps> = [
  ...
  { prop: 'src', value: 'https://i.pravatar.cc/100', placeholder: 'No src' },
...
<template>
  <ExampleView
    v-slot="attrs"
    title="Avatar"
    description="An img element with fallback"
    :controls="controls"
  >
    <div>
      <UAvatar v-bind="attrs" />
    </div>
  </ExampleView>
</template>
